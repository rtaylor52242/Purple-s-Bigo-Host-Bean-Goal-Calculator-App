...
export interface UserProfile {
  ...
  timeZone: string;
  maxPathways?: number;
  currentHours?: number; // Re-added
  currentForeignBeanCount?: number; // Re-added
  preferredDates?: Set<string>; // Re-added: Stores selected dates from the calendar as ISO strings
}
...
export interface AppContextType {
  ...
  setRegionalTiers: Dispatch<SetStateAction<RegionalTier[] | null>>; // Re-added
  theme: 'light' | 'dark';
